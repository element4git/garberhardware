<section class="about-us" id="aboutus">
	<div class="container">
		...
		<div class="col-lg-<?php echo $colCount; ?> col-md-<?php echo $colCount; ?> column zerif-rtl-skills ">
			<div><img src="<?php echo get_template_directory_uri(); ?>/images/oldtymephoto.jpg" /></div>
			<p class="small">Grandpa Ralph with sisters Anna, Sylvia and Benny Garber. Reflected in the mirror is great-grandma Katie Garber with Henry in a stroller, circa 1908</p>
